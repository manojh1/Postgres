...
variable "client_id" {
    type = string
    default = "29f2ee90-11d7-4853-b0e7-e2bc1f8324e5"
}
variable "tenant_id" {
    type = string
...
variable "client_secret" {
    type = string
    default = "j4J8Q~ASUecDp4ZbY7E6yN8hgTcFCpEKdI6dCb6T"
}
